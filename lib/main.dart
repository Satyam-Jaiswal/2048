...
import 'package:TZFE_game/tile.dart';
  ...
  List<Widget> getGrid(double width, double height) {
    ...
    for (int i = 0; i < 4; i++) {
      for (int j = 0; j < 4; j++) {
        ...
        int color;
        if (num == 0) {
          color = CustomColors.emptyGridBackground;
          number = "";
        } else if (num == 2 || num == 4) {
          color = CustomColors.gridColorTwoFour;
          number = "${num}";
        } else if (num == 8 || num == 64 || num == 256) {
          color = CustomColors.gridColorEightSixtyFourTwoFiftySix;
          number = "${num}";
        } else if (num == 16 || num == 32 || num == 1024) {
          color = CustomColors.gridColorSixteenThirtyTwoOneZeroTwoFour;
          number = "${num}";
        } else if (num == 128 || num == 512) {
          color = CustomColors.gridColorOneTwentyEightFiveOneTwo;
          number = "${num}";
        } else {
          color = CustomColors.gridColorWin;
          number = "${num}";
        }
        double size;
        String n = "${number}";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color(CustomColors.gridBackground),
      ),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: Color(CustomColors.gridBackground),
                  ),
                  height: 82.0,
                  child: Column(
                    children: <Widget>[
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    isgameOver
                        ? Container(
                            height: height,
                            color: Color(CustomColors.transparentWhite),
                            child: Center(
                              child: Text(
                                'Game over!',
                                style: TextStyle(
